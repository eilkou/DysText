...
from C12_jargon_and_abbreviation import C12_score
...
#     """
    ...
    # The output is always in single column so C13 is 0
    C13_score=0
    ...
    visual=C1+C2+C3+C4+C7+C10+C13

    print('C1=',C1)
    print('C7=',C7)
    #Calculate Content features
    content=C5+C6+C8+C9+C11+C12
