...
def get_instructions(text):
    ...
    # For binary metrics, we take the Max - error
    # For continuous metrics, we take the 80% (good performance) - error
    if C1<1-e:
        instructions.append(
    ...
    if C2<0-e:
        instructions.append(
            "Avoid italics as this can make the text appear to run together and cause crowding."
        )
        failed.append("C2")
    if C3<0-e:
        instructions.append(
            "Avoid Underlining as this can make the text appear to run together and cause crowding."
        )
        failed.append("C3")
    if C4<1-e:
        instructions.append(
    ...
    if C9<1-e:
        instructions.append(
            "Break up the text with regular section headings in long documents."
        )
        failed.append("C9")
    if C10<1-e:
        instructions.append(
